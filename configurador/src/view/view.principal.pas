...
begin
  ...
  cbDriver1.ItemIndex := cbDriver1.Items.IndexOf(Controller.INI.Conexao1.Driver);
  edtServidor1.Text   := Controller.INI.Conexao1.Servidor;
  edtPorta1.Text      := Controller.INI.Conexao1.Porta.ToString;
  edtBanco1.Text      := Controller.INI.Conexao1.Banco;
  edtUsuario1.Text    := Controller.INI.Conexao1.Usuario;
  edtSenha1.Text      := Controller.INI.Conexao1.Senha;
  edtCharset1.Text    := Controller.INI.Conexao1.CharSet;
  edtCollate1.Text    := Controller.INI.Conexao1.Collate;
  ckbLogSql1.Checked  := Controller.INI.Conexao1.LogSQL;
  edtEsquema1.Text    := Controller.INI.Conexao1.Esquema;
  edtInatividade1.Text:= Controller.INI.Conexao1.Inatividade.ToString;

  cbDriver2.ItemIndex := cbDriver2.Items.IndexOf(Controller.INI.Conexao2.Driver);
  edtServidor2.Text   := Controller.INI.Conexao2.Servidor;
  edtPorta2.Text      := Controller.INI.Conexao2.Porta.ToString;
  edtBanco2.Text      := Controller.INI.Conexao2.Banco;
  edtUsuario2.Text    := Controller.INI.Conexao2.Usuario;
  edtSenha2.Text      := Controller.INI.Conexao2.Senha;
  edtCharset2.Text    := Controller.INI.Conexao2.CharSet;
  edtCollate2.Text    := Controller.INI.Conexao2.Collate;
  ckbLogSql2.Checked  := Controller.INI.Conexao2.LogSQL;
  edtEsquema2.Text    := Controller.INI.Conexao2.Esquema;
  edtInatividade2.Text:= Controller.INI.Conexao2.Inatividade.ToString;
...
begin
  ...
  Controller.INI.Conexao1.Driver   := cbDriver1.Text;
  Controller.INI.Conexao1.Servidor := edtServidor1.Text ;
  Controller.INI.Conexao1.Porta    := StrToInt(edtPorta1.Text);
  Controller.INI.Conexao1.Banco    := edtBanco1.Text;
  Controller.INI.Conexao1.Usuario  := edtUsuario1.Text;
  Controller.INI.Conexao1.Senha    := edtSenha1.Text;
  Controller.INI.Conexao1.CharSet  := edtCharset1.Text;
  Controller.INI.Conexao1.Collate  := edtCollate1.Text;
  Controller.INI.Conexao1.LogSQL   := ckbLogSql1.Checked;
  Controller.INI.Conexao1.Esquema  := edtEsquema1.Text;
  Controller.INI.Conexao1.Inatividade := StrToInt(edtInatividade1.Text);

  Controller.INI.Conexao2.Driver   := cbDriver2.Text;
  Controller.INI.Conexao2.Servidor := edtServidor2.Text ;
  Controller.INI.Conexao2.Porta    := StrToInt(edtPorta2.Text);
  Controller.INI.Conexao2.Banco    := edtBanco2.Text;
  Controller.INI.Conexao2.Usuario  := edtUsuario2.Text;
  Controller.INI.Conexao2.Senha    := edtSenha2.Text;
  Controller.INI.Conexao2.CharSet  := edtCharset2.Text;
  Controller.INI.Conexao2.Collate  := edtCollate2.Text;
  Controller.INI.Conexao2.LogSQL   := ckbLogSql2.Checked;
  Controller.INI.Conexao2.Esquema  := edtEsquema2.Text;
  Controller.INI.Conexao2.Inatividade := StrToInt(edtInatividade2.Text);
