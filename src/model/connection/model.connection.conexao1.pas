  ...
  try
    ...
    begin
      ...
      begin
        ...
        Params.Values['CHARSET']  := ini.Conexao1.CharSet;
      end;
    end
    else
    begin
    ...
    try
      ...
      tmrInatividade.Interval := ini.Conexao1.Inatividade * 1000;
      tmrInatividade.Enabled  := ini.Conexao1.Inatividade > 0;
    except on e:Exception do
