...
type
  ...
  public
    ...
    function TotalPorFormaPgto(dInicial, dFinal: TDate; out Erro: String): Boolean;
    {$EndRegion}
...
function TDespesaReport.TotalPorFormaPgto(dInicial, dFinal: TDate; out
  Erro: String): Boolean;
begin
  try
...
begin
  ...
  FSerieBarra := TBarSeries.Create(nil);
  FSQL := '';
end;
