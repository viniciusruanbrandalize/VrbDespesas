...
uses
  ...
  model.entity.despesaformapagamento, model.entity.cartao, model.connection.ini,
  ...
  model.dao.participante, view.subtipodespesa, view.usuario, view.logerro,
  view.loglogin, view.login, view.bandeira, view.contabancaria,
  view.participante, Controls;
